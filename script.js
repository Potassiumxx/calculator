...
function operate(firstNumber, secondNumber, operator) {
  switch (operator) {
    case "+":
      answer = add(Number(firstNumber), Number(secondNumber));
      currentTextField.textContent = answer;
      break;
    case "−":
      answer = subtract(Number(firstNumber), Number(secondNumber));
      currentTextField.textContent = answer;
      break;
    case "×":
      answer = multiply(Number(firstNumber), Number(secondNumber));
      currentTextField.textContent = answer;
      break;
    case "÷":
      answer = divide(Number(firstNumber), Number(secondNumber));
    ...
    default:
      if (!selectSpecialKey) {
        previousTextField.textContent = `${Number(currentTextField.textContent)} =`;
        currentTextField.textContent = Number(currentTextField.textContent);
      } else {
...
function displayNumber(number) {
  ...
  firstNumber = Number(previousTextField.textContent);
  secondNumber = Number(currentTextField.textContent);
}
...
function displayAnswer() {
  if (toggleEquals) {
    firstNumber = Number(currentTextField.textContent);
  } else {
    firstNumber = Number(previousTextField.textContent);
    secondNumber = Number(currentTextField.textContent);
  }
...
function changeSign() {
  ...
  if (toggleEquals) {
    ...
    previousTextField.textContent = previousTextField.textContent.replace(
      `${firstNumber} ${operatorSign} ${secondNumber}`,
      answer,
    );
...
function getReciprocal() {
  ...
  if (toggleEquals) {
    ...
    previousTextField.textContent = previousTextField.textContent.replace(
      `1/(${firstNumber} ${operatorSign} ${secondNumber} =)`,
      `1/(${Number(number)})`,
    );
  } else {
    previousTextField.textContent = previousTextField.textContent.replace(
...
function getSquareNumber() {
  ...
  if (toggleEquals) {
    ...
    previousTextField.textContent = previousTextField.textContent.replace(
      `sqr(${firstNumber} ${operatorSign} ${secondNumber} =)`,
      `sqr(${Number(number)})`,
    );
  } else {
    previousTextField.textContent = previousTextField.textContent.replace(
